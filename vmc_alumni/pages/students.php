...
<div class="content-box">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h3 class="fw-bold text-primary m-0">Manage Students</h3>

        <button class="btn btn-add" id="btnAddStudent">+ New Student</button>
    </div>
...
<div class="modal fade" id="studentModal" tabindex="-1">
 ...
 <input type="hidden" id="year_graduared" name="year_graduared" value="-">
                    <div class="row g-3">
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary" id="saveBtn" type="submit">Save Student</button>
                </div>
            </div>
        </form>
    </div>
